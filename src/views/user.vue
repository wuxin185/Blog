<template>
  <div>
        ...
        <div class="user-left">
          <div style="display: flex; align-items: center">
            ...
            <el-avatar class="user-avatar" @click.native="changeDialog('修改头像')" :size="60"
              :src="currentUser.avatar || $store.state.webInfo.avatar"></el-avatar>
          </div>
          ...
          <div style="margin-top: 20px">
            <proButton :info="'提交'" @click.native="submitUserInfo()" :before="$constant.before_color_1"
    ...
    <el-dialog :title="dialogTitle" :visible.sync="showDialog" width="30%" :before-close="clearDialog"
      :append-to-body="true" :close-on-click-modal="false" center custom-class="dialog">
      <div class="myCenter" style="flex-direction: column">
        ...
        <div style="display: flex; margin-top: 30px" v-show="dialogTitle !== '修改头像'">
          ...
          <proButton :info="'提交'" @click.native="submitDialog()" :before="$constant.before_color_1"
            :after="$constant.after_color_1">
          </proButton>
        </div>
      </div>
