  ...
  <div>
    ...
    <el-form :model="article" :rules="rules" ref="ruleForm" label-width="110px" class="demo-ruleForm">
      ...
      <el-form-item label="封面" prop="articleCover">
        ...
        <uploadPicture :isAdmin="true" :ResourceType="'articleCover'" style="margin-top: 10px"
          @addPicture="addArticleCover" :maxSize="3" :maxNumber="1"></uploadPicture>
      </el-form-item>
