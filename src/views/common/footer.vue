<template>
  <footer id="footer">
    <div id="footer_icons">
      <div>
        <a class="icon_link" target="_blank" rel="noopener" href="http://106.54.224.73:81/#/" title="个人主页">
        ...
        <a class="icon_link" href="https://blog.csdn.net/qq_53461589?spm=1010.2135.3001.5421" title="CSDN主页"
          data-pjax-state="">
          <i class="iconfont icon-csdn">
          </i>
        </a>
      </div>
      <img class="footer_logo entered loaded" :src="require('../../../public/title.jpg')"
        data-lazy-src="../../../public/title.jpg" data-ll-status="loaded" />
      <div>
        <a class="icon_link" target="_blank" rel="noopener" href="https://github.com/monkey-papa/POEMON-BLOG"
          title="Github主页">
          <i class="iconfont icon-github"></i>
        </a>
        <a class="icon_link" target="_blank" rel="noopener"
          href="https://www.bilibili.com/video/BV1nh4y1m7CV/?spm_id_from=333.999.0.0" title="哔哩哔哩主页">
        ...
        <a class="icon_link" target="_blank" rel="noopener" href="https://www.foreverblog.cn/go.html"
          title="随机访问十年之约友链博客">
    ...
    <div id="footer_content">
      <div class="footer-group">
        ...
        <div class="footer-links">
          <a class="footer-item" href="http://106.54.224.73:81/#/tools" data-pjax-state="">藏宝阁</a>
          <a class="footer-item" href="http://106.54.224.73:81/#/friend" data-pjax-state="">友链</a>
          <a class="footer-item" href="http://106.54.224.73:81/#/message" data-pjax-state="">留言厅</a>
          <a class="footer-item" href="http://106.54.224.73:81/#/travel " data-pjax-state="">个人相册</a>
          <a class="footer-item" href="http://106.54.224.73:81/#/funny" data-pjax-state="">幻音坊</a>
        </div>
      </div>
      <div class="footer-group">
        <h3 class="footer-title">分类</h3>
        <div class="footer-links">
          <a class="footer-item" href="http://106.54.224.73:81/#/sort?sortId=1" data-pjax-state="">学习笔记</a>
          <a class="footer-item" href="http://106.54.224.73:81/#/sort?sortId=6" data-pjax-state="">我的项目</a>
          <a class="footer-item" href="http://106.54.224.73:81/#/sort?sortId=3" data-pjax-state="">游戏</a>
          <a class="footer-item" href="http://106.54.224.73:81/#/sort?sortId=4" data-pjax-state="">动漫</a>
          <a class="footer-item" href="http://106.54.224.73:81/#/sort?sortId=7" data-pjax-state="">随想</a>
          <a class="footer-item" href="http://106.54.224.73:81/#/sort" data-pjax-state="">查看全部</a>
        </div>
      </div>
      <div class="footer-group" id="friend-links-in-footer">
        ...
        <div class="footer-links">
          ...
          <a class="footer-item" href="http://106.54.224.73:81/#/friend" data-pjax-state="">查看更多</a>
        </div>
      </div>
    </div>
      ...
      <div class="footer-bottom-content">
        <div class="footer-bottom-left">
          <span>Copyright © 2023 By
            <a target="_blank" rel="noopener" href="http://106.54.224.73:81/#/" title="点击访问Fsleep的主页"
              style="margin-left: 5px">Fsleep
            </a>
          </span>
          <div>
