        ...
        <div class="content-main">
          ...
          <div class="author-content accordion">
            <div class="author-content-item chuckle-img">
              <div class="container">
                <div v-for="(item, i) in images" :key="i" class="item" @click="btnClick(i)"
                  :class="{ active: current == i }" :style="{ backgroundImage: `url(${item.img})` }">
...
.author-content-item.map {
  background: url(https://www.qiniuyun.monke-papa.icu/avatar/map.png) no-repeat center;
  min-height: 200px;
  max-height: 400px;
  position: relative;
  overflow: hidden;
...
.author-content-item.maxim {
  ...
  display: flex;
  color: var(--favoriteBg);
  background: url(https://www.qiniuyun.monke-papa.icu/avatar/about1.jpg) no-repeat;
  background-size: cover;
  align-items: flex-start;
  flex-direction: column;
  justify-content: center;
...
.author-content-item.myphoto {
  background: url(https://www.qiniuyun.monke-papa.icu/avatar/about2.webp) no-repeat;
  height: 60%;
  background-size: 100%;
...
.author-content-item.game-lol {
  background: url(https://www.qiniuyun.monke-papa.icu/avatar/%E9%95%9C.png) no-repeat top;
  background-size: cover;
  min-height: 300px;
  overflow: hidden;
  color: var(--white);
...
.author-content-item.game-wolf {
  border: 1px;
  width: 56%;
  background: url(https://www.qiniuyun.monke-papa.icu/avatar/%E8%A1%8C%E5%B0%B8%E8%B5%B0%E8%82%89.jpg) no-repeat top;
  background-size: cover;
  min-height: 300px;
  overflow: hidden;
  color: var(--white);
...
.author-content-item.like-technology {
  border: 1px;
  background: url(https://www.qiniuyun.monke-papa.icu/avatar/iphone.jpg) no-repeat;
  background-size: cover;
  min-height: 230px;
  color: var(--red);
}
...
.author-content-item.like-music {
  border: 1px;
  background: url(https://www.qiniuyun.monke-papa.icu/avatar/Jay.webp) no-repeat top;
  background-size: cover;
  min-height: 400px;
  color: var(--orange1);
  overflow: hidden;
